...
class LeadSignal(Base):
    ...
    has_booking: Mapped[bool | None] = mapped_column(Integer, nullable=True)
    has_chatbot: Mapped[bool | None] = mapped_column(Integer, nullable=True)
    has_instagram: Mapped[bool | None] = mapped_column(Integer, nullable=True)
    has_whatsapp: Mapped[bool | None] = mapped_column(Integer, nullable=True)
    has_telegram: Mapped[bool | None] = mapped_column(Integer, nullable=True)
    pain_mentions: Mapped[list] = mapped_column(JSON, default=list)
